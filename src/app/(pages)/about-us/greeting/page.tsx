    ...
    return (
      <>
          ...
          <div className="container">
              <section className="section-type-01 bg-01">
                  <div className="text-area">
                      ...
                      <p>{language?.greeting_03}<br/>{language?.greeting_04}<br/>{language?.greeting_05}<br/>{language?.greeting_06}<br/>{language?.greeting_07}<br/>{language?.greeting_08}</p>
                      {/*<p>{language?.greeting_04}</p>
                        <p>{language?.greeting_05}</p>
                        <p>{language?.greeting_06}</p>
                        <p>{language?.greeting_07}</p>
                        <p>{language?.greeting_08}</p>*/}
                      <p style={{margin: "30px 0 0"}}>{language?.greeting_09}</p>
          ...
          <div className="container4">
              <div>
                  <section className="section-type-02 bg-02">
                      <div className="text-area">
                  ...
                  <section className="section-type-02 bg-03">
                      <div className="image-area">
          ...
          <div className="container3">
              <div>
                  <section className="section-type-03 bg-04">
                      <div className="text-area">
