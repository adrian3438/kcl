...
export default async function ControlValvePage({searchParams: {lang}}: any) {
    ...
    const productImageList = [
        "/images/sub/products/control/kcl-control-valve-1.jpg",
        "/images/sub/products/control/kcl-control-valve-2.jpg",
        "/images/sub/products/control/kcl-control-valve-3.jpg",
        "/images/sub/products/control/kcl-control-valve-4.jpg",
        "/images/sub/products/control/kcl-control-valve-5.jpg",
        "/images/sub/products/control/kcl-control-valve-6.jpg",
    ];
