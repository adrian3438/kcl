            ...
            <div className="certificates">
                ...
                {certificates === 0 && (
                    <section className="vendor">
                         <dl>
                            <dt>
                                <Image src="/images/sub/certificates/united-states-flag.png" alt="USA" width={228} height={120}/>
                                <p>{language?.certificates_04_01}</p>
                            </dt>
                            <dd>
                                <ul>
                                    <li>FLUOR (United States of America)<a>{language?.certificates_btn_03}</a></li>
                                </ul>
                            </dd>
                        </dl>
                        ...
                        <dl>
                            ...
                            <dd>
                                <ul>
                                    ...
                                    <li>MOP OF IRAN (Ministry Oil Petroleum-Iran)<a>{language?.certificates_btn_03}</a></li>
                                    <li>POGC (Pars Oil and Gas Company-Iran)<a>{language?.certificates_btn_03}</a></li>
                        ...
                        <dl>
                            ...
                            <dd>
                                <ul>
                                    ...
                                    <li>ADNOC (Abu Dhabi National Oil Company- UAE)<a>{language?.certificates_btn_03}</a></li>
                                    <li>BOROUGE (Abu Dhabi Polymers Company- UAE)<a>{language?.certificates_btn_03}</a></li>
                                    <li>TAKREER (Abu Dhabi Oil Refining Company- UAE)<a>{language?.certificates_btn_03}</a></li>
                                    <li>RUWAIS (A Subsidiary of ADNOC- UAE)<a>{language?.certificates_btn_03}</a></li>
                                    <li>GASCO (Abu Dhabi Gas Company-Can be checked online- UAE)<a>{language?.certificates_btn_03}</a></li>
                                </ul>
                            </dd>
                        </dl>
                        <dl>
                            <dt>
                                <Image src="/images/sub/certificates/qatar.png" alt="Qatar" width={228} height={120}/>
                                <p>{language?.certificates_06_01}</p>
                            </dt>
                            <dd>
                                <ul>
                                    <li>{language?.certificates_06_02}<a>{language?.certificates_btn_03}</a></li>

                                    <li>QATAR Steel<a>{language?.certificates_btn_03}</a></li>
                                    <li>QATAR Fuel (QAFAC)<a>{language?.certificates_btn_03}</a></li>
                                    <li>QATAR Petroleum<a>{language?.certificates_btn_03}</a></li>
                                </ul>
                            </dd>
                        </dl>
                        <dl>
                        ...
                        <dl>
                            <dt>
                                <Image src="/images/sub/certificates/egypt-flag.png" alt="EGYPT" width={228} height={120}/>
                                <p>{language?.certificates_07_01}</p>
                            </dt>
                            <dd>
                                <ul>
                                    <li>KPC (KHALDA PETROLEUM COPMPANY-Egypt)<a>{language?.certificates_btn_03}</a></li>
                                    <li>GASCO(Egyptian Natural Gas Co-Egypt)<a>{language?.certificates_btn_03}</a></li>
                                </ul>
                            </dd>
                        </dl>
                        ...
                        <dl>
                            <dt>
                                <Image src="/images/sub/certificates/iraq-flag.png" alt="IRAQ" width={228} height={120}/>
                                <p>{language?.certificates_07_01}</p>
                            </dt>
                            <dd>
                                <ul>
                                    <li>BGC (Basrah Gas COPMPANY-Iraq)<a>{language?.certificates_btn_03}</a></li>
                                    <li>GNB (Gazprom Neft Badra -Iraq)<a>{language?.certificates_btn_03}</a></li>
                                    <li>MRC (MIDLAND REFINERIES COMPANY- Iraq)<a>{language?.certificates_btn_03}</a></li>
                                </ul>
                            </dd>
                        </dl>
